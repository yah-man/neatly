...
function neatly_breadcrumb_list(){
	...
	$link_before      = '<li class="f_box ai_c mb8"><span class="mr4 svg18 sub_fc">'. neatly_get_theme_svg( 'folder-open-o' ) .'</span>';
	$link_after       = '</li>';
	...
	$delimiter        = '<span class="ml8 mr8 mb8 svg10 sub_fc">'. neatly_get_theme_svg( 'angle-double-right' ) .'</span>';/* Delimiter between crumbs' &raquo; '*/
	$before           = '<li class="f_box ai_c mb8"><span class="mr4 svg18 sub_fc">'. neatly_get_theme_svg( 'file-text-o' ) .'</span><span class="current">';/* Tag before the current crumb*/
	...
	if ( is_home() || is_front_page() ) {
		...
		if ( is_paged() ) {
			...
			$breadcrumb_output_link .= '<li class="f_box ai_c mb8"><span class="mr4 svg18 sub_fc">'. neatly_get_theme_svg( 'home' ) .'</span> <a href="' . $home_link . '" class="lh_1"><span class="breadcrumb_home">' . $home_text . '</span></a></li>';
	...
	if(!get_theme_mod( 'neatly_breadcrumbs_current',true)){
		$str = '/<\/li> &raquo; <li class="f_box ai_c mb8"><span class="mr4 svg18 sub_fc">'. neatly_get_theme_svg( 'file-text-o' ) .'</span> <span class=\"current\">(.*)<\/span><\/li>/u';
		$breadcrumb_output_link = preg_replace( $str , '</li>' , $breadcrumb_output_link ,1);
	}
	$breadcrumb_output_link = '<nav class="post_item mb_L"><ol id="breadcrumb" class="breadcrumb f_box f_wrap001 ai_c o_s_t pb8 lh_1">'.$breadcrumb_output_link.'</ol></nav><!-- .breadcrumbs -->';
